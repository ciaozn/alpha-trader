...
| 字段 | 值 |
|---|---|
| 状态 | Approved v1.0 · **执行中**（2026-09-12：P0-P3 完成；**P4 进行中** T401/T402 已完成；T321/T409 待用户验收） |
| 创建日期 | 2026-09-08 |
...
| P4 | 加固 + OKX + 告警 | 可 7×24 无人值守的模拟盘 | GW-03/06、OP-02/03、EN-05、RK-06/09、EX-05 | SC-03（7 天连续运行） | ⏳ 进行中：T401 邮件告警 ✅、T402 状态接口 ✅、T403-T408 待办 |
...
> **进度（2026-09-12）**：细任务见 [tasks.md](./tasks.md) §P4（T401-T409）。
> 已完成：T401 邮件告警（QQ SMTP、异步出站、同类五分钟聚合、CRITICAL 立即发）、
> T402 `/api/status`（持仓/权益/心跳/网关健康/当日已实现盈亏，离线 profile 不启 Web 容器）。
> 待办：T403 崩溃恢复、T404 风控热更新、T405 幽灵仓位处置、T406 OKX 网关、T407 Docker、T408 MySQL。
